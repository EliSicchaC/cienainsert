...
public class PhysicalContext {
    ...
    public static void main(String[] args) {
        PhysicalContext physical = new PhysicalContext();
        physical.llamarAlMetodo("D:\\archivos\\objetociena.json","tapi-common:context",
                "tapi-equipment:physical-context");
    }
    public void llamarAlMetodo(String rutaDelArchivo,String tapiContext,String physicalContext){
        PhysicalContext physical = new PhysicalContext();
        try{
